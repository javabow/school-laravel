...
class AlumniController extends Controller
{
    public function index()
    {
        ...
        return view('admin-templates.admin.alumni', ['staff'=>$staff]);
    }
    ...
    {
      return view('admin-templates.admin.alumni-create');
    }
    ...
    {
      $staff = Staff::find($id);
      return view('admin-templates.admin.alumni-edit', ['staff'=>$staff]);
    }
