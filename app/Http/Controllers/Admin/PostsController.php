...
class PostsController extends Controller
{
    ...
    public function index()
    {
        ...
        $posts = Posts::all();
        return view('admin-templates.admin.posts', ['posts'=>$posts, 'postStatus'=>$postStatus]);
    }
    ...
    public function create()
    {
        ...
        $tags = Tags::all();
        return view('admin-templates.admin.posts-create', ['categories'=>$categories, 'tags'=>$tags]);
    }
    ...
    public function edit($id)
    {
        ...
        $tags = Tags::all();
        // dd($post->categories);
        return view('admin-templates.admin.posts-edit', ['id'=>$id, 'categories'=>$categories, 'tags'=>$tags, 'post'=>$post]);
    }
