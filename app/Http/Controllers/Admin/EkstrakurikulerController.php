...
class EkstrakurikulerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin-templates.admin.ekstrakurikuler', ['ekstrakurikuler'=>$ekstrakurikuler]);
    }
    ...
    {
      return view('admin-templates.admin.ekstrakurikuler-create', ['colorList'=>$this->colorList, 'iconList'=>$this->iconList]);
    }
    ...
    public function edit($id)
    {
      ...
      return view('admin-templates.admin.ekstrakurikuler-edit', ['ekstrakurikuler'=>$ekstrakurikuler, 'colorList'=>$this->colorList, 'iconList'=>$this->iconList]);
    }
