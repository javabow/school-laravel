...
class UsersController extends Controller
{
    ...
    public function index()
    {
        if ($this->isAdmin()) {
          $users = Users::all();
          return view('admin-templates.admin.users', ['users'=>$users]);
        } else {
    ...
    public function create()
    {
      if ($this->isAdmin()) {
        ...
        return view('admin-templates.admin.users-create', ['userRoles'=>$userRoles]);
      } else {
        return back()->with('danger', 'Ups anda tidak memiliki wewenang..');
      }
    }
    ...
    public function edit($id)
    {
      if ($this->isAdmin() || Auth::user()->id == $id) {
        $user = Users::find($id);
        $userRoles = UserRoles::all();
        return view('admin-templates.admin.users-edit', ['user'=>$user, 'userRoles'=>$userRoles]);
      } else {
        return back()->with('danger', 'Ups anda tidak memiliki wewenang..');
      }
    }
