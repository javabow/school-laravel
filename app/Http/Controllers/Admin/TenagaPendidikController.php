...
class TenagaPendidikController extends Controller
{
    public function index()
    {
        ...
        return view('admin-templates.admin.tenaga-pendidik', ['staff'=>$staff]);
    }
    ...
    {
      return view('admin-templates.admin.tenaga-pendidik-create');
    }
    ...
    {
      $staff = Staff::find($id);
      return view('admin-templates.admin.tenaga-pendidik-edit', ['staff'=>$staff]);
    }
